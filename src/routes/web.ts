...
import { getCartPage, getCheckOutPage, getDetailPage, postAddProductToCart, postDeleteProductInCart, postHandleCartToCheckOut } from 'controllers/client/product.controller';
